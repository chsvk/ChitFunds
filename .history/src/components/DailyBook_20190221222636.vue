<template>
    <div class="groups">
        ...
        <table>
            ...
            <tr>
                <datepicker :format="customFormat" v-model="data.today"></datepicker>
                <td>
...
export default {
    ...
    methods: {
        ...
        add(){
            var vm = this;
            vm.data = {...vm.data, date: this.computeDate}
    ...
    computed: {
        computeDate(){
            return this.data.today = String(this.date.today).substring(8,10)
        }
    }
}
</script>
