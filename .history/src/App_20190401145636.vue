          ...
          GroupMembers.forEach((Member)=>{
            ...
            for(var i =0; i<Member['No Of Groups']; i++){
              if(Object.values(Member)[i+4] != ""){
                ...
                db.collection("Members").doc(userObject.mid).collection("Groups").doc(groupObject.name).set(groupObject).then(()=>{
                  db.collection("Groups").doc(groupObject.name).collection("Members").doc(userObject.mid).set(userObject).then(()=>{
